...
# Set up environment
# For details of the environment see https://www.gymlibrary.dev/environments/classic_control/cart_pole/
...
def collect_trajectory(env, policy_net):
    ...
    while not done:
        ...
        # with torch.no_grad(): # We do not want this to influence the gradient of the NN
