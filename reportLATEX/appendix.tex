...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{figures/plot_Cartpole_Extrinsic Return.pdf}
...
\begin{table}[ht]
\centering
\caption{Hyperparameters not stated by \cite{rle-paper} for the \textsc{IsaacLab} experiments.}
\begin{tabular}{{ll}} 
\hline
\textbf{Hyperparameter} & \textbf{Value}\\\hline
