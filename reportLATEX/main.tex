...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.32\textwidth}
    ...
    \caption{The \textsc{Alien} environment is an example of the \textsc{Atari} games consisting of a maze filled with 'eggs' to destroy while being hunted by aliens. A flamethrower or occasional power-up may be used to scare the aliens.}
  ...
  \begin{subfigure}[b]{0.32\textwidth}
    ...
    \caption{The \textsc{CartPole} environment is available in \textsc{IsaacLab}.\\\textcolor{white}{.}\\\textcolor{white}{.}\\}
