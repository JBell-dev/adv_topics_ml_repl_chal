...
\begin{itemize}
  ...
  \item RLE perforamnce deteriorates if the random reward function is simply white noise (N(0,1)) and thus uncorrelated to the states.
\end{itemize}
...
\noindent The code for our implementations can be found in GitHub\footnote{\href{https://github.com/jonupp/adv_topics_ml_repl_chal}{https://github.com/jonupp/adv\_topics\_ml\_repl\_chal} \textcolor{red}{Change github}}.
...
\noindent To run the code we experimented with the CPU, T4 GPU and TPU v2-8 in Google Colab, integrated with Weights \& Biases (wandb) for easier runtime visualization of the scores and other measures.
