...
Wherever possible we used the same hyperparameters as the authors, except for $z$-resampling frequency in the \textsc{Atari} games. For the parameters that were missing a description in the paper we adopted values that seemed reasonable to us, which you can find in the \hyperlink{appendix-hyperparams}{appendix C}.
