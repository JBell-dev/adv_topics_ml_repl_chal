...
# Note: after installing baselines3 you might have to uninstall gymnasium and install version 0.28.1 again
# because with baseline3 you get gymnasium 1.0.0
import os
import random
import time
...
from four_room_grid_world.util.plot_util import plot_heatmap, calculate_states_entropy
...
"""
    ...
    for global_step in range(args.total_timesteps):
            ...
            if d:
                ...
                if args.track:
                    wandb.log({"charts/episodic_return": episodic_return,
                             "charts/episodic_length": episode_length}, step=global_step)
        ...
        if args.track and global_step != 0:
