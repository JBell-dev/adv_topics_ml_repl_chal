...
agent_save_file = f"{save_path}/{run_name}_agent.pt"
torch.save(agent.state_dict(), agent_save_file)
print(f"Agent model saved into {agent_save_file}")

# Save the RND model
rnd_save_file = f"{save_path}/{run_name}_rnd_model.pt"
torch.save(rnd_model.state_dict(), rnd_save_file)
print(f"RND model saved into {rnd_save_file}")
